...
ouvertes, leur réintégration, le déclenchement, les codes, les badges, les
notifications, les entités de configuration et les erreurs de services.
Le flux de configuration et d'options est couvert intégralement. La CI refuse
toute régression sous 95 % de couverture.
...
??? const.py                 # Constantes
??? runtime_data.py          # Données partagées à l'exécution
